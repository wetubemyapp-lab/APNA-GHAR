...
export const TopAppBar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200/80 px-3 sm:px-4 py-2.5 transition-all">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-1.5 sm:gap-2">
        {/* Left: Apna Ghar Brand & City Selector */}
        <div className="flex items-center gap-2 sm:gap-3">
          <ApnaGharLogo size="sm" />

          {/* City Selector Pill - Material 3 Tonal Button */}
          <button
