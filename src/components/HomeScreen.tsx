          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {projects.map(proj => (
              <div
                ...
                className="group bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-xs hover:shadow-md transition-all cursor-pointer flex flex-col"
              >
                <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                  ...
                  <div className="absolute bottom-2.5 left-2.5 right-2.5 flex items-baseline justify-between text-white">
                    <span className="text-base font-extrabold drop-shadow-md">{proj.priceRange}</span>
                ...
                <div className="p-4 flex flex-col flex-1 justify-between gap-2.5">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-medium">{proj.locality}, {proj.city}</p>
                    <p className="text-xs text-slate-600 line-clamp-2 mt-1.5">{proj.highlight}</p>
                  </div>

                  <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-xs">
                    <div className="flex items-center gap-1 text-slate-600 font-medium">
                      <Building2 className="w-3.5 h-3.5 text-blue-600" />
                      <span>{proj.configurations.slice(0, 3).join(', ')}</span>
                    </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3.5">
            {localities.map(loc => (
              <div
                ...
                className="group bg-white p-4 rounded-3xl border border-slate-200/90 shadow-2xs hover:shadow-md hover:border-blue-400 transition-all cursor-pointer flex flex-col justify-between gap-3 active:scale-[0.98]"
              >
                <div className="flex items-start justify-between">
                  <div>
                ...
                <div className="pt-2 border-t border-slate-100 flex items-baseline justify-between text-xs">
                  <div>
                    ...
                    <strong className="text-slate-900 font-bold">₹{loc.avgRatePerSqFt.toLocaleString()}</strong>
                  ...
                  <div className="text-right">
                    ...
                    <span className="text-xs font-bold text-blue-600">{loc.rentalYield}</span>
                  </div>
                </div>
              </div>
            ))}
